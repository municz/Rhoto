...
Rhoto is a web-application in programmed in Ruby on Rails and uses Bootstrap and KnockoutJS. It's based on MySQL database.
...
6. remove registration button from homepage with removing lines in app/views/home.index.html.erb
